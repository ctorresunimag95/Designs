...
public class CsprojEditorTests
{
    ...
    {
        var result = _editor.AddProjectReference(MinimalCsproj, "../AspireGuide.ServiceBusExplorer/AspireGuide.ServiceBusExplorer.csproj");
        Assert.Contains("ProjectReference", result.Text);
        Assert.Contains("AspireGuide.ServiceBusExplorer.csproj", result.Text);
    ...
    {
        var first = _editor.AddProjectReference(MinimalCsproj, "../AspireGuide.ServiceBusExplorer/AspireGuide.ServiceBusExplorer.csproj");
        var second = _editor.AddProjectReference(first.Text, "../AspireGuide.ServiceBusExplorer/AspireGuide.ServiceBusExplorer.csproj");
