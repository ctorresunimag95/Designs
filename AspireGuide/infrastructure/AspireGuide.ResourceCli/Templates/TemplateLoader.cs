...
namespace AspireGuide.ResourceCli.Templates;
...
internal static class TemplateLoader
{
    ...
    private static string ResourcePrefix => "AspireGuide.ResourceCli.Templates.";

    /// <summary>
    /// Loads a region template for the given resource key.
    /// Returns the full content including the stable aspireguide markers.
    /// </summary>
