...
public static class ResourceCatalog
{
    ...
    [
        ...
        new ResourceDefinition(
            ...
            Description: "Blazor UI for browsing Service Bus queues/topics, peeking and resubmitting dead-letter messages against the local emulator. Requires the servicebus resource and the AspireGuide.ServiceBusExplorer project.",
            ...
            RequiredProject: new ProjectRequirement(
                ProjectName: "AspireGuide_ServiceBusExplorer",
                RelativePath: "infrastructure/AspireGuide.ServiceBusExplorer/AspireGuide.ServiceBusExplorer.csproj",
                ScaffoldFiles:
                [
                    "AspireGuide.ServiceBusExplorer.csproj",
                    "appsettings.json",
