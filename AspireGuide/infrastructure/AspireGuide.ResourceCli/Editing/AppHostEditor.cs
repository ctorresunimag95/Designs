...
namespace AspireGuide.ResourceCli.Editing;
...
public sealed partial class AppHostEditor
{
    ...
    [GeneratedRegex(@"Projects\.AspireGuide_ServiceBusExplorer\b", RegexOptions.CultureInvariant)]
    private static partial Regex ServiceBusExplorerRegex();
    [GeneratedRegex("//\\s*<aspireguide\\s+resource\\s*=\\s*[\\\"'](?<key>[^\\\"']+)[\\\"']\\s*>", RegexOptions.IgnoreCase | RegexOptions.Compiled, "es-CO")]
