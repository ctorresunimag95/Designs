...
The repository implementation preserves directory structure and infers content types in `infrastructure/AspireGuide.AppHost/Extensions/BlobExtensions.cs`. Use the optional `blobOptionsModifier` to set options such as access tier.
