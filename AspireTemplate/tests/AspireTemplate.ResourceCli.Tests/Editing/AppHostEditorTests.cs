...
public class AppHostEditorTests
{
    ...
    public void InsertRegions_Should_InsertServiceBusBeforeBuildAnchor()
    {
        ...
        Assert.Contains("AspireTemplate resource=\"servicebus\"", result.Text);
    ...
    public void InsertRegions_Should_PlaceInsertionBeforeAnchorLine()
    {
        ...
        var markerIndex = result.Text.IndexOf("AspireTemplate resource=\"appconfiguration\"", StringComparison.Ordinal);
    ...
    public void InsertRegions_Should_InsertMultipleResourcesInCatalogOrder()
    {
        ...
        var sbIdx = result.Text.IndexOf("AspireTemplate resource=\"servicebus\"", StringComparison.Ordinal);
        var kcIdx = result.Text.IndexOf("AspireTemplate resource=\"keycloak\"", StringComparison.Ordinal);
    ...
    {
        var text = """
            // <AspireTemplate resource="servicebus">
            // content
            // </AspireTemplate>
            builder.Build().Run();
            """;
    ...
    {
        var text = "// <AspireTemplate resource=\"servicebus\">\nbuilder.Build().Run();";
